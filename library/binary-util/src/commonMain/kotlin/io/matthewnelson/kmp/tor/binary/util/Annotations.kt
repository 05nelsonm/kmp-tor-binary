 ...
 *
 * Any usage of a declaration annotated with [InternalKmpTorBinaryApi]
 * must be accepted by annotating that usage with the [OptIn]
 * annotation, e.g. @OptIn(InternalKmpTorBinaryApi::class), or by using
 * the following compiler argument:
 *
 *   -Xopt-in=io.matthewnelson.kmp.tor.binary.util.InternalKmpTorBinaryApi
 * */
@RequiresOptIn
@MustBeDocumented
@Target(
