...
import io.matthewnelson.kmp.tor.binary.extract.ConstantsBinaries.ARCHIVE_SHA256_VALUE_MACOS_X64
...
class ResourceValidationUnitTest {
    ...
    fun givenBinaryResource_whenLinuxX64_sha256SumMatchesConstants() {
        val kmptorDotZip = File(
            ...
            "/jvmMain/resources/kmptor/linux/x64/$ARCHIVE_FILE_NAME_KMPTOR"
        )
    ...
    fun givenBinaryResource_whenLinuxX86_sha256SumMatchesConstants() {
        val kmptorDotZip = File(
            ...
            "/jvmMain/resources/kmptor/linux/x86/$ARCHIVE_FILE_NAME_KMPTOR"
        )
        val actual = sha256Sum(kmptorDotZip)
    ...
    fun givenBinaryResource_whenMacosX64_sha256SumMatchesConstants() {
        val kmptorDotZip = File(
            ...
            "/jvmMain/resources/kmptor/macos/x64/$ARCHIVE_FILE_NAME_KMPTOR"
        )
        val actual = sha256Sum(kmptorDotZip)
        assertEquals(ARCHIVE_SHA256_VALUE_MACOS_X64, actual)
    }
    ...
    fun givenBinaryResource_whenMingwX64_sha256SumMatchesConstants() {
        val kmptorDotZip = File(
            ...
            "/jvmMain/resources/kmptor/mingw/x64/$ARCHIVE_FILE_NAME_KMPTOR"
        )
        val actual = sha256Sum(kmptorDotZip)
    ...
    fun givenBinaryResource_whenMingwX86_sha256SumMatchesConstants() {
        val kmptorDotZip = File(
            ...
            "/jvmMain/resources/kmptor/mingw/x86/$ARCHIVE_FILE_NAME_KMPTOR"
        )
        val actual = sha256Sum(kmptorDotZip)
    ...
    fun givenGeoipResource_whenJvmJsCommon_sha256SumMatchesConstants() {
        val geoipsDotZip = File(
            geoipSrcDir,
            "/jvmMain/resources/kmptor/geoips.zip"
        )
        val actual = sha256Sum(geoipsDotZip)
        assertEquals(ARCHIVE_SHA256_VALUE_GEOIP, actual)
    }
...
//        val geoipsDotZip = File(
//            geoipSrcDir,
//            "/nativeMain/resources/kmptor/geoips.tar.gz"
//        )
//        val actual = sha256Sum(geoipsDotZip)
//        assertEquals(ARCHIVE_SHA256_VALUE_GEOIP, actual)
//    }
