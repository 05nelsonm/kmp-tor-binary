...
kmpPublish {
    setupModule(
        pomDescription = "Kotlin Components' TorBinary distribution for macOS x64",
    )
}

npmPublish {
    description = "npm distribution of macOS x64 Tor binary files for the kmp-tor project"
    files {
        from(projectDir) {
            include("index.js")
        }
