 ...
 **/
package io.matthewnelson.differ.core.internal.apply

import io.matthewnelson.differ.core.Differ
import io.matthewnelson.differ.core.Header
import io.matthewnelson.differ.core.Header.Companion.readDiffFileHeader
import io.matthewnelson.differ.core.internal.BASE16
import io.matthewnelson.differ.core.internal.checkExistsAndIsFile
import io.matthewnelson.differ.core.internal.create.Create.Companion.EOF_HASH
    ...
    internal companion object {
        ...
        internal fun diff(fs: FileSystem, diffFile: Path, applyTo: Path) {
            ...
            fs.read(diffFile) {
                ...
                when (header.schema) {
                    is Differ.Schema.v1 -> V1(fs, header, this, applyTo)
                }
            }
        }
    }
